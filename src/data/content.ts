...
export const about = {
  headline: "關於我",
  description: [
    "你好！我是來自台灣的 Panda Tseng，一位自媒體創作者與區塊鏈愛好者，熱衷於連結真實與虛擬世界之間的鴻溝。",
    "擁有資訊管理背景及豐富的區塊鏈實務經驗，自 2017 年起積極參與 Web3 生態系統的建設與發展。",
    "透過 WalkinCat 走路貓自媒體，分享關於 AI、生產力工具、Web3 與區塊鏈的深入見解，致力於將複雜科技轉化為易懂內容。",
  ],
  highlights: [
    "WalkinCat 走路貓自媒體創作者，主要活躍於 Instagram",
    "多項區塊鏈競賽獎項，包括國際區塊鏈奧林匹亞亞軍",
    "全端開發者，專精於 iOS 與後端開發",
  ],
};
